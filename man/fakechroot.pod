...
C<FAKECHROOT_EXCLUDE_PATH>, C<FAKECHROOT_INCLUDE_PATH>,
C<FAKECHROOT_EXCLUDE_SYMLINK>, C<FAKECHROOT_CMD_SUBST> or C<LD_LIBRARY_PATH>.
...
=item B<FAKECHROOT_INCLUDE_PATH>

The list of directories which are included from being chrooted. The elements
of list are separated with colon.
