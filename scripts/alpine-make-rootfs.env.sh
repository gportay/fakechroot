...
@UMOUNT@=/bin/true
/bin/busybox=${fakechroot_bindir:-@bindir@}/ld-musl-x86_64.so.1.fakechroot
/bin/bbsuid=${fakechroot_bindir:-@bindir@}/ld-musl-x86_64.so.1.fakechroot
/bin/busybox-extras=${fakechroot_bindir:-@bindir@}/ld-musl-x86_64.so.1.fakechroot
